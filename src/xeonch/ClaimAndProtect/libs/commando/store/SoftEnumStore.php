...
namespace xeonch\ClaimAndProtect\libs\commando\store;
...
use xeonch\ClaimAndProtect\libs\commando\exception\CommandoException;
...
class SoftEnumStore
{
	...
	public static function broadcastPacketInstance(array $players, $pk)
	{
	...
	{
		self::broadcastPacketInstance(Server::getInstance()->getOnlinePlayers(), $pk);
	}
}
